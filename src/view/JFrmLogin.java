...
public class JFrmLogin extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTxtApelido, javax.swing.GroupLayout.PREFERRED_SIZE, 399, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnEntrarActionPerformed
        ...
        String valorApelido = jTxtApelido.getText();
        String valorSenha = new String(jPwfSenha.getPassword());

        UsuariosDAO usuarioDAO = new UsuariosDAO();

        boolean login = usuarioDAO.listLogin(valorApelido, valorSenha);
        if (login) {
