...
public class JDlgConsultaVendas extends javax.swing.JDialog {
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        // TODO add your handling code here:
       if(jTxtTotal.getText().isEmpty() == false && jTxtFuncionario.getText().isEmpty() == false){
           List lista = (List) vendasDAO.listFuncionarioTotal(jTxtFuncionario.getText(),Util.strToDouble(jTxtTotal.getText()) );
        controllerConsultasVendas.setList(lista);
        }
        else if(jTxtFuncionario.getText().isEmpty() == false){
        List lista = (List) vendasDAO.listFuncionario(jTxtFuncionario.getText());
        controllerConsultasVendas.setList(lista);
        } else if(jTxtTotal.getText().isEmpty() == false) {
        List lista = (List) vendasDAO.listTotal(Util.strToDouble(jTxtTotal.getText()));
        controllerConsultasVendas.setList(lista);
