...
public class JDlgConsultaFuncionarios extends javax.swing.JDialog {
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        // TODO add your handling code here:
        if(jTxtSalario.getText().isEmpty() == false && jTxtNome.getText().isEmpty() == false){
           List lista = (List) funcionariosDAO.listNomeValor(jTxtNome.getText(),Util.strToDouble(jTxtSalario.getText()) );
        controllerConsultasFuncionarios.setList(lista);
        }
        else if(jTxtNome.getText().isEmpty() == false){
        List lista = (List) funcionariosDAO.listNome(jTxtNome.getText());
        controllerConsultasFuncionarios.setList(lista);
        } else if(jTxtSalario.getText().isEmpty() == false) {
        List lista = (List) funcionariosDAO.listValor(Util.strToDouble(jTxtSalario.getText()));
        controllerConsultasFuncionarios.setList(lista);
